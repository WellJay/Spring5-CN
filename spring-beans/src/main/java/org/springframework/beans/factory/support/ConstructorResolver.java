...
class ConstructorResolver {
	...
	public BeanWrapper autowireConstructor(String beanName, RootBeanDefinition mbd,
		...
		if (constructorToUse == null) {
			 ...
			 * 1. public Kok(Object o1, Object o2, Object o3)
			 * 2. public Kok(Object o1, Object o2)
			 * 3. public Kok(Object o1)
			 * 4. protected Kok(Integer i, Object o1, Object o2, Object o3)
			 * 5. protected Kok(Integer i, Object o1, Object o2)
			 * 6. protected Kok(Integer i, Object o1)
			 */
					...
					try {
						...
						if (paramNames == null) {
							...
							if (pnd != null) {
								//获取构造方法参数名称列表
								/**
								 * 假设你有一个（String kok,Object zilu）
								 * 则paramNames=[kok,zilu]
								 */
